...
function updatePosts() {
    ...
    fetch("https://muraldenoticias.netlify.app/api/all").then(res=>{
        return res.json();
    }).then(json=>{  
        let postElements = " ";
...
function newPost() {
    ...
    fetch("https://muraldenoticias.netlify.app/api/new", options).then(res=>{
        console.log(res)
        updatePosts();
...
function deletePost(event) {
   ...
   console.log(id)
    ...
    fetch("https://muraldenoticias.netlify.app/api/deleta", options).then(res=>{
        updatePosts();
    })
}
